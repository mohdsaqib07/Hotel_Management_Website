    ...
    <section className="flex md:flex-row flex-col px-4 py-10 items-center gap-12 container mx-auto">
      ...
      <div className="md:py-10 md:w-1/2 text-left">
        ...
        <p className="font-normal max-w-md">
          {featuredRoom.description.slice(0, 201)}
        </p>
        <div className="flex flex-col md:flex-row md:items-end justify-between mt-5">
          ...
          <Link
            ...
            className="border h-fit text-center border-tertiary-dark text-tertiary-dark dark:border-sky-600 hover:border-none dark:text-sky-600 hover:bg-tertiary-dark hover:text-[#f5f5f5] dark:hover:bg-sky-600 dark:hover:text-[#f5f5f5] transition-all duration-500 px-3 py-2 lg:py-5 lg:px-7 rounded-2xl font-bold lg:text-xl"
          >
            More Details
          </Link>
        </div>
